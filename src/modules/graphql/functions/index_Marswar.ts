...
export async function getNftData_Marswar(
  ...
  try {
    const data: any = await graphQLClient.request(qplMarswar.getNftData, variables);
...
export async function getNftsData_Marswar(
  ...
  if (filters?.metadataStar != undefined) {
    variables["where"]["metadataStar_gte"] = parseInt(filters?.metadataStar.min!.toString());
    variables["where"]["metadataStar_lte"] = parseInt(filters?.metadataStar.max!.toString());
  }
  ...
  try {
    const data: any = await graphQLClient.request(qplMarswar.getNftsData, variables);
...
export async function getNftDataOffering_Marswar(
  ...
  try {
    const data: any = await graphQLClient.request(qplMarswar.getNftDataOffering, variables);
